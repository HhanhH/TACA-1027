...
//import cn.springboot.service.auth.UserInfoService;
//
//@Service("userService")
...
//        }
//
//        UserInfo u = userMapper.findUserByName(user.getUsername());
//        if(u!=null){
...
//            log.debug("## update UserInfo password.");
//        }
//        UserInfo u = userMapper.findById(user.getId());
...
//    @Transactional
//    @Override
//    public void updateUserLastLoginTime(UserInfo user) {
//        UserInfo u = userMapper.findById(user.getId());
//        if (u != null) {
//            user = new UserInfo();
...
//
//    @Override
//    public List<UserInfo> findEmp(String shopId, String empName) {
