...
<body>
	...
	<div class="tpl-portlet-components" style="height:474px;">
		<div class="portlet-title">
			<div class="caption font-green bold">编辑称号</div>
		</div>
					...
					<div class="am-form-group">
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button type="button"
									class="am-btn am-btn-primary tpl-btn-bg-color-success " onclick="edit(${honorTitle.id})" >提交</button>
							</div>
						</div>
					</form>
