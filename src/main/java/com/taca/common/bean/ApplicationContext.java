...
public class ApplicationContext implements ServletContextAware {
    ...
    private static final Logger log = LoggerFactory.getLogger(cn.springboot.common.util.ApplicationContext.class);
    ...
    public void setServletContext(ServletContext context) {
        String datetime = cn.springboot.common.util.DateUtil.dateToString(Calendar.getInstance().getTime(), DateUtil.fm_yyyyMMddHHmmssSSS);
