...
<script src="../../static/js/admin/groupuserList.js"></script>
		...
		<div class="tpl-content-wrapper">
			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">部门人员列表</div>
					
					<form id="form" action="${base}/admin/user/groupUser" method="post" enctype="application/x-www-form-urlencoded">
                    <input type="hidden" id="currentPage" name="currentPage" value="${page.currentPage}"/>
                    <input type="hidden" id="responseURL" name="responseURL" value="${base}/admin/user/groupUser"/>
											...
											<td>
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
													 ...
													 <nobr> <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><a href="${base}/admin/user/info/${user.id}"> 详情</a></button>
														<button class="am-btn am-btn-default am-btn-xs am-text-secondary"><a href="${base}/admin/user/goUpdate/${user.id}"> 编辑</a></button>
														<#if user.status=='ACTIVE'>
														
														<button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="active(${user.id})">
															注销</button></#if>
															<#if user.status=='INACTIVE'>
															<button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="active(${user.id})">激活 
															</button>
															</#if>
